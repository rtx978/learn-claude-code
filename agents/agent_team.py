...
class RequestStore:
    ...
    One JSON file per request_id is stored under .team/requests/.
    """
...
from s16 import _append_claim_event,_task_allows_role,is_claimable_task,scan_unclaimed_tasks,claim_task,make_identity_block,ensure_identity_context
